...
class ViewDetailProject extends HtmlResponse{
   ...
   function ParseTemplate($data = NULL) {
      ...
      if ($listProject[0]['projectToleUse']=='Pakai') {
        if (strtotime($listProject[0]['projectDateToleStart'])<=0) {
        ...
        if (strtotime($listProject[0]['projectDateToleEnd'])<=0) {
      ...
      if (strtotime($listProject[0]['projectDateMtcEnd'])<=0) {
        $listProject[0]['projectDateMtcEnd'] ='-';
      }
      if (strtotime($listProject[0]['projectDateBast'])<=0) {
        $listProject[0]['projectDateBast'] ='-';
      }
      //var_dump(strtotime($listProject[0]['projectDateMtcEnd']));exit;
