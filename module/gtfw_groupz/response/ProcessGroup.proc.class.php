...
class ProcessGroup {
   ...
   function __construct () {
      ...
      $this->pageView = Dispatcher::Instance()->GetUrl('gtfw_groupz', 'group', 'view', 'html');
      $this->pageInput = Dispatcher::Instance()->GetUrl('gtfw_groupz', 'inputGroup', 'view', 'html');
   ...
   function SendAlert($alert, $sub_modul, $css='') {
      Messenger::Instance()->Send('gtfw_groupz', $sub_modul, 'view', 'html', array($this->_POST, $alert, $css),Messenger::NextRequest);
   }
