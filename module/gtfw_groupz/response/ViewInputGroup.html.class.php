...
class ViewInputGroup extends HtmlResponse {
   ...
   function TemplateModule() {
      $this->SetTemplateBasedir(Configuration::Instance()->GetValue( 'application', 'docroot').'module/gtfw_groupz/template');
   ...
   function ParseTemplate($data = NULL) {
      ...
      $this->mrTemplate->AddVar('content', 'URL_ACTION', Dispatcher::Instance()->GetUrl('gtfw_groupz', $url, 'do', 'html'));
      $this->mrTemplate->AddVar('content', 'URL_BACK', Dispatcher::Instance()->GetUrl('gtfw_groupz','Group','view','html'));
      if($dataGroup)
